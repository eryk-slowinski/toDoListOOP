// Figure out how to call TasksCounter.counter() so it executes also when you remove the task.
    ...
    constructor() {
        ...
        this.addButton.addEventListener('click', () => {
            if (this.inputAdd.value !== "")
                AddingTasks.addTask(this.inputAdd, this.tasksList);
        ...
        RemovingTask.removeTask(this.tasksList);
    }
}